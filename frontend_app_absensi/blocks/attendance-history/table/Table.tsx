...
/* ================= MAIN COMPONENT ================= */
export default function TableAttendanceHistory() {
  ...
  const selectedAttendanceHistories = useAttendanceStore((s) => s.selectedAttendanceHistories);

  const totalPages = Math.ceil(selectedAttendanceHistories.length / itemsPerPage);

  const currentData = selectedAttendanceHistories.slice(

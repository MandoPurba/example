...
export default function TableShift() {
    ...
    const page = useShiftStore((s) => s.page);
    const deleteShift = useShiftStore((s) => s.deleteShift);
    const setEditShift = useShiftStore((s) => s.setEditShift);
    const setPagination = useShiftStore((s) => s.setPagination);
    const setShifts = useShiftStore((s) => s.setShifts);
    const openModal = useShiftStore((s) => s.openModal);

    const [openDropdownId, setOpenDropdownId] = useState<string | null>(null);

    const totalPages = page || 1;
    const currentData = shifts;
        ...
        const fetchData = async () => {
            try {
                ...
                const res = await fetch(
                    `${NEXT_PUBLIC_API_URL}/shifts?search=${debouncedSearch}&page=${currentPage}&limit=${itemsPerPage}`,
                ...
                <Table>
                    ...
                    <TableHeader>
                        <TableRow>
                            ...
                            <TableCell isHeader>Grace Minutes</TableCell>
                        ...
                        {loading
                            ...
                            : currentData.map((b: any) => (
                                <TableRow key={b.id}>
                                    ...
                                    <TableCell>{b.graceMinutes}</TableCell>
